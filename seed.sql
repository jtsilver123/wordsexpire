...
-- Mark every seeded petal above as an example, so the app can say so.
UPDATE petals SET is_example = 1 WHERE id IN (
  ...
  'b2000001-0001-4001-8001-000000000001', 'b2000002-0002-4002-8002-000000000002',
  'b2000003-0003-4003-8003-000000000003', 'b2000004-0004-4004-8004-000000000004',
  'b2000005-0005-4005-8005-000000000005', 'b2000006-0006-4006-8006-000000000006',
  'b3000001-0001-4001-8001-000000000001', 'b3000002-0002-4002-8002-000000000002',
  'b3000003-0003-4003-8003-000000000003'
);
